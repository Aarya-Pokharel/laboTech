  ...
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-gradient-to-br from-blue-50 to-yellow-50 min-h-screen">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="actions/login" method="POST">
        <div>
          ...
          <div class="mt-2">
            <input type="email" name="email" id="email" autocomplete="email" required
              class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 border border-gray-300 placeholder:text-gray-400 focus:border-yellow-500 focus:ring-yellow-500">
          </div>
        </div>
        <div>
        ...
        <div>
          <button type="submit"
            class="flex w-full justify-center rounded-md bg-yellow-500 px-3 py-2 text-base font-semibold text-white shadow-sm hover:bg-yellow-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-500 transition">
            Sign in
          </button>
        </div>
      </form>
